                                                    ...
                                                    <div class="row g-2 mb-2 social-entry">
                                                        ...
                                                        <div class="col-md-2 text-center">
                                                            <button type="button" id="addSocialBtn"
                                                                ...
                                                                <img src="{{ asset('assets/images/iconly/png/plus.png') }}"
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            addTaxBtn.addEventListener("click", function() {
                ...
                taxEntry.classList.add("row", "g-2", "tax-entry");
                taxEntry.innerHTML = `
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <button type="button" class="btn remove-tax p-2 rounded-circle">
                                            <img src="{{ asset('assets/images/iconly/png/bin.png') }}" alt="Delete" class="img-fluid" style="max-width: 20px;">
                                        </button>
                                    </div>
                                `;
