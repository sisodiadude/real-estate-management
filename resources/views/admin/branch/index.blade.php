                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <h3>245</h3>
                                        <span class="fs-14 text-black">Total Customers</span>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <h3>562</h3>
                                        <span class="fs-14 text-black">Total Transactions</span>
                                    </div>
                                    <span class="bg-primary rounded p-3">
                    ...
                    <div class="col-xl-12">
                        <div class="table-responsive fs-14">
                            <table class="table display mb-4 dataTablesCard overflow-hidden card-table"
                                id="example5">
                                <thead>
                                    <tr>
                                        <th>
