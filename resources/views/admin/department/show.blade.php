                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="custom-tab-1">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade" id="trashedTeams">
                                                        <div class="pt-4">
                                                            <div class="table-responsive fs-14">
                                                                <div class="col-12">
                                                                    <div
    ...
    <script>
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if ({!! json_encode($hasPermissions) !!}.some(perm => perm.group ===
                                ...
                                deleteButton =
                                    `<a class="dropdown-item text-black delete-team" href="javascript:void(0);" data-url="${data.delete}">Delete</a>`;
                            }
            ...
            $('#teamTable').on('click', '.delete-team', function(e) {
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "This action will remove the team from the list.",
                    icon: "warning",
                                    ...
                                    success: function(response) {
                                        Swal.fire({
                                            ...
                                            text: response.message ||
                                                (response.status ?
                                                    "The team has been removed successfully." :
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if ({!! json_encode($hasPermissions) !!}.some(perm => perm.group ===
                                ...
                                restoreButton =
                                    `<a class="dropdown-item text-black restore-trashed-team" href="javascript:void(0);" data-url="${data.restore}">Restore</a>`;
                            }
                            if ({!! json_encode($hasPermissions) !!}.some(perm => perm.group ===
                                    "Admin Department" && perm
                                    .action === "permanent_delete") && data.delete) {
                                deleteButton =
                                    `<a class="dropdown-item text-black delete-trashed-team" href="javascript:void(0);" data-url="${data.delete}">Delete</a>`;
                            }
            ...
            $('#trashedTeamTable').on('click', '.delete-trashed-team', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "This action is irreversible! The team will be permanently deleted and cannot be restored.",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#d33",
                    cancelButtonColor: "#6c757d",
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        Swal.fire({
                                            ...
                                            text: response.message ||
                                                (response.status ?
                                                    "The team has been removed forever and cannot be recovered." :
                                                    "An unexpected error occurred. Please try again."
                                                ),
                                            icon: response.status ?
                                                "success" : "error",
            ...
            $('#trashedTeamTable').on('click', '.restore-trashed-team', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "This will bring back the team and make it active again.",
                    icon: "question",
                    showCancelButton: true,
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        Swal.fire({
                                            ...
                                            text: response.message ||
                                                (response.status ?
                                                    "The team has been successfully restored." :
                                                    "An unexpected error occurred. Please try again."
                                                ),
                                            icon: response.status ?
                                                "success" : "error",
