        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="form-head page-titles d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="mb-1 fw-bold">Edit Employee: {{ $employee->full_name }}</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a
                                        href="{{ route('admin.branches.departments.teams.employees.show', ['branchSlug' => $branch->slug, 'departmentSlug' => $department->slug, 'teamSlug' => $team->slug, 'employeeUsername' => $employee->username]) }}">{{ $employee->full_name }}</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ route('admin.branches.departments.teams.employees.update', ['branchSlug' => $branch->slug, 'departmentSlug' => $department->slug, 'teamSlug' => $team->slug, 'employeeUsername' => $employee->username]) }}"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="email" id="alternative_email" name="alternative_email"
                                                ...
                                                value="{{ old('alternative_email', $employee->alternative_email) }}">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label for="date_of_birth" class="form-label fw-bold">Date of Birth
                                                {{ old('date_of_birth', $employee->date_of_birth) }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="date" id="date_of_birth" name="date_of_birth"
                                                class="form-control pickdate-picker"
                                            ...
                                            <select id="nationality" name="nationality_id"
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('nationality_id', $employee->nationality_id) == $country->id ? 'selected' : '' }}>
                                                        {{ $country->nationality }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="account_status" name="account_status"
                                                ...
                                                <option value="active"
                                                    {{ old('account_status', $employee->account_status) == 'active' ? 'selected' : '' }}>
                                                    Active</option>
                                                <option value="inactive"
                                                    {{ old('account_status', $employee->account_status) == 'inactive' ? 'selected' : '' }}>
                                                    Inactive</option>
                                                <option value="suspended"
                                                    {{ old('account_status', $employee->account_status) == 'suspended' ? 'selected' : '' }}>
                                                    Suspended</option>
                                                <option value="archived"
                                                    {{ old('account_status', $employee->account_status) == 'archived' ? 'selected' : '' }}>
                                                    Archived</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="current_address_line1"
                                                ...
                                                value="{{ old('current_address_line1', $employee->current_address_line1) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="current_address_line2"
                                                ...
                                                value="{{ old('current_address_line2', $employee->current_address_line2) }}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select id="current_country" name="current_country_id"
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('current_country_id', $employee->current_country_id) == $country->id ? 'selected' : '' }}>
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">Country is required.</div>
                                            ...
                                            <select id="current_state" name="current_state_id"
                                                ...
                                                @foreach ($current_states as $state)
                                                    <option value="{{ $state->id }}"
                                                        {{ old('current_state_id', $employee->current_state_id) == $state->id ? 'selected' : '' }}>
                                                        {{ $state->name }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select id="current_city" name="current_city_id"
                                                ...
                                                @foreach ($current_cities as $city)
                                                    <option value="{{ $city->id }}"
                                                        {{ old('current_city_id', $employee->current_city_id) == $city->id ? 'selected' : '' }}>
                                                        {{ $city->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="current_postal_code" name="current_postal_code"
                                                ...
                                                value="{{ old('current_postal_code', $employee->current_postal_code) }}"
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="form-check form-switch mb-3">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    {{ $employee->same_as_current_address ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="permanent_address_line1"
                                                ...
                                                placeholder="Enter address line 1"
                                                value="{{ old('permanent_address_line1', $employee->permanent_address_line1) }}"
                                                required maxlength="100">
                                            <div class="invalid-feedback">Address Line 1 is required.</div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="permanent_address_line2"
                                                ...
                                                placeholder="Enter address line 2" maxlength="100"
                                                value="{{ old('permanent_address_line2', $employee->permanent_address_line2) }}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select id="permanent_country" name="permanent_country_id"
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('permanent_country_id', $employee->permanent_country_id) == $country->id ? 'selected' : '' }}>
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">Country is required.</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="permanent_state" name="permanent_state_id"
                                                ...
                                                @foreach ($permanent_states as $state)
                                                    <option value="{{ $state->id }}"
                                                        {{ old('permanent_state_id', $employee->permanent_state_id) == $state->id ? 'selected' : '' }}>
                                                        {{ $state->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">State is required.</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="permanent_city" name="permanent_city_id"
                                                ...
                                                @foreach ($current_cities as $city)
                                                    <option value="{{ $city->id }}"
                                                        {{ old('permanent_city_id', $employee->permanent_city_id) == $city->id ? 'selected' : '' }}>
                                                        {{ $city->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">City is required.</div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="permanent_postal_code"
                                                ...
                                                value="{{ old('permanent_postal_code', $employee->permanent_postal_code) }}">
                                            <div class="invalid-feedback">Postal code is required.</div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select id="employment_type" name="employment_type"
                                                ...
                                                <option value="full_time"
                                                    {{ old('employment_type', $employee->employment_type) == 'full_time' ? 'selected' : '' }}>
                                                    Full-Time</option>
                                                <option value="part_time"
                                                    {{ old('employment_type', $employee->employment_type) == 'part_time' ? 'selected' : '' }}>
                                                    Part-Time</option>
                                                <option value="contract"
                                                    {{ old('employment_type', $employee->employment_type) == 'contract' ? 'selected' : '' }}>
                                                    Contract</option>
                                                <option value="internship"
                                                    {{ old('employment_type', $employee->employment_type) == 'internship' ? 'selected' : '' }}>
                                                    Internship</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="bank_account" name="bank_account"
                                                ...
                                                value="{{ old('bank_account', $employee->bank_account) }}" required>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div id="allowanceContainer">
                                                @php
                                                    $allowancesDetails = json_decode($employee->allowances, true) ?? [];
                                                @endphp
                                                @foreach ($allowancesDetails as $index => $allowance)
                                                    <div class="row g-2 mb-2 allowance-entry">
                                                        <div class="col-md-6">
                                                            <select class="form-select dropdown-select allowance-type"
                                                                name="allowances[{{ $index }}][type]">
                                                                <option value="" selected>Select Allowance
                                                                </option>
                                                                @php
                                                                    $allowanceTypes = [
                                                        ...
                                                        <div class="col-md-2 text-center">
                                                            ...
                                                            @else
                                                                <button type="button"
                                                                    class="btn p-2 rounded-circle remove-allowance">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div id="deductionContainer">
                                                @php
                                                    ...
                                                    $deductionsDetails = json_decode($employee->deductions, true) ?? [];
                                                @endphp
                                                @foreach ($deductionsDetails as $index => $deduction)
                                                    <div class="row g-2 mb-2 deduction-entry">
                                                        ...
                                                        <div class="col-md-2 text-center">
                                                            ...
                                                            @else
                                                                <button type="button"
                                                                    class="btn p-2 rounded-circle remove-deduction">
                                                                    <img src="{{ asset('assets/images/iconly/action/minus.png') }}"
                                                                        alt="Add" class="img-fluid"
                                                                        style="max-width: 20px;">
                                                                </button>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="ifsc_swift_code" name="ifsc_swift_code"
                                                ...
                                                value="{{ old('ifsc_swift_code', $employee->ifsc_swift_code) }}"
                                                required>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="pan_tax_id" name="pan_tax_id"
                                                ...
                                                value="{{ old('pan_tax_id', $employee->pan_tax_id) }}" required>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select name="salary_frequency" id="salary_frequency"
                                                ...
                                                <option value="weekly"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'weekly' ? 'selected' : '' }}>
                                                    Weekly</option>
                                                <option value="biweekly"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'biweekly' ? 'selected' : '' }}>
                                                    Bi-Weekly (Every 2 Weeks)</option>
                                                <option value="semimonthly"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'semimonthly' ? 'selected' : '' }}>
                                                    Semi-Monthly (1st & 15th)</option>
                                                <option value="monthly"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'monthly' ? 'selected' : '' }}>
                                                    Monthly</option>
                                                <option value="quarterly"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'quarterly' ? 'selected' : '' }}>
                                                    Quarterly</option>
                                                <option value="semiannually"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'semiannually' ? 'selected' : '' }}>
                                                    Semi-Annually (Every 6 Months)</option>
                                                <option value="annually"
                                                    {{ old('salary_frequency', $employee->salary_frequency) == 'annually' ? 'selected' : '' }}>
                                                    Annually (Yearly)</option>
                                            </select>
                                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(event) {
                ...
                const sameAsCurrentAddress = document.getElementById("same_as_current_address")
                    .checked ? 1 :
                    0;
                console.log(`sameAsCurrentAddress - `, sameAsCurrentAddress);
                // AJAX Submission
                ...
                getCurrentLocation(
                    (location) => {
                        ...
                        fetch("{{ route('admin.branches.departments.teams.employees.update', ['branchSlug' => $branch->slug, 'departmentSlug' => $department->slug, 'teamSlug' => $team->slug, 'employeeUsername' => $employee->username]) }}", {
                                method: "POST",
                                body: formData,
                                headers: {
