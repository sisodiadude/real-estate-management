                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="salary_frequency" id="salary_frequency"
                                                ...
                                                <option value="weekly" {{ old('salary_frequency', $employee->salary_frequency) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                                <option value="biweekly" {{ old('salary_frequency', $employee->salary_frequency) == 'biweekly' ? 'selected' : '' }}>Bi-Weekly (Every 2 Weeks)</option>
                                                <option value="semimonthly" {{ old('salary_frequency', $employee->salary_frequency) == 'semimonthly' ? 'selected' : '' }}>Semi-Monthly (1st & 15th)</option>
                                                <option value="monthly" {{ old('salary_frequency', $employee->salary_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                                <option value="quarterly" {{ old('salary_frequency', $employee->salary_frequency) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                                                <option value="semiannually" {{ old('salary_frequency', $employee->salary_frequency) == 'semiannually' ? 'selected' : '' }}>Semi-Annually (Every 6 Months)</option>
                                                <option value="annually" {{ old('salary_frequency', $employee->salary_frequency) == 'annually' ? 'selected' : '' }}>Annually (Yearly)</option>
                                            </select>
                                        </div>
