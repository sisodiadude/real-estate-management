...
var omah = function () {
    ...
    var handleDatetimepicker = function () {
        ...
        if (jQuery('.bt-datepicker').length > 0) {
            $('.bt-datepicker').each(function () {
                let $this = $(this);
                let options = {
                    autoclose: $this.data('autoclose') === true,
                    todayHighlight: $this.data('today-highlight') === true
                };

                // Initialize datepicker
                $this.datepicker(options);

                // If there's already a value (like from old input or database), set it
                if ($this.val()) {
                    $this.datepicker('update', $this.val());
                } else if ($this.data('default-date') === true) {
        ...
        if ($('.bt-timepicker').length > 0) {
            $('.bt-timepicker').each(function () {
                let $this = $(this);
                let options = {
                    autoclose: true,
                    default: $this.data('default-time') === true ? new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : ''
                };
                ...
                // Set default time if enabled
                if ($this.data('default-time') === true) {
                    $this.val(options.default);
                }
            });
        }
    }
