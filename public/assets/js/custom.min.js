    ...
    var handleDatetimepicker = function () {
        if (jQuery('.bt-datepicker').length > 0) {
            $('.bt-datepicker').each(function () {
                ...
                // Conditionally set default date
                if ($this.data('default-date') === true) {
                    options.defaultViewDate = new Date();
                    $this.datepicker(options).datepicker('update', new Date());
                } else {
                    $this.datepicker(options).val(''); // Keep input empty
                }
            });
        }
    }
